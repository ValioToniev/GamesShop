...
namespace GamesShop.Infrastructure.Migrations
{
    ...
    [Migration("20250110132910_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamesShop.Infrastructure.Data.Entities.Address", b =>
                {
            ...
            modelBuilder.Entity("GamesShop.Infrastructure.Data.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GamesShop.Infrastructure.Data.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GamesShop.Infrastructure.Data.Entities.Product", b =>
                {
                    b.HasOne("GamesShop.Infrastructure.Data.Entities.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GamesShop.Infrastructure.Data.Entities.Genre", "Genre")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("GamesShop.Infrastructure.Data.Entities.ApplicationUser", b =>
                {
                    b.HasOne("GamesShop.Infrastructure.Data.Entities.Address", "Address")
                        .WithMany()
